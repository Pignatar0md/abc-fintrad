...
import Beneficiaries from 'screens/Authenticated/Beneficiaries/Beneficiaries';
import { fontSizes } from 'styles';
import { BeneficiaryListScreenNavigationProp } from 'types/types';

const BeneficiariesBottomTabbar: FC<BeneficiaryListScreenNavigationProp> = (): ReactElement => {
...
export default BeneficiariesBottomTabbar;
